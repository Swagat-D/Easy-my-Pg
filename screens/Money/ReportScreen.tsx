...
export default function ReportScreen({
  ...
  onSectionPress,
  activeTab = 'money',
  currentMoneySection = 'report' // Default to report
}: ReportScreenProps) {
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        <View style={styles.pageContent}>
          ...
          <Text style={styles.pageDescription}>Financial reports and analytics page coming soon...</Text>
          <View style={styles.demoContent}>
            <Text style={styles.demoText}>📊 Financial Reports</Text>
            <Text style={styles.demoText}>📈 Analytics Dashboard</Text>
            <Text style={styles.demoText}>📋 Export Reports</Text>
          </View>
        </View>
      </ScrollView>
